function loading() {
    const assets = [
        '../../assets/aviso_treinamento.png',
        '../../assets/cafeteira.png',
        '../../assets/escritorio.png',
        '../../assets/logo_simplificado.png',
        '../../assets/audios/soundtrack/0.mp3',
        '../../assets/audios/soundtrack/1.mp3',
        '../../assets/audios/soundtrack/2.mp3',
        '../../assets/audios/soundtrack/3.mp3',
        '../../assets/cafe/0.png',
        '../../assets/cafe/1.png',
        '../../assets/cafe/2.png',
        '../../assets/cafe/3.png',
        '../../assets/cafe/4.png',
        '../../assets/cafe/bebendo.png',
        '../../assets/conquistas/amarelo-grande.png',
        '../../assets/conquistas/amarelo.png',
        '../../assets/conquistas/azul.png',
        '../../assets/conquistas/conquista.png',
        '../../assets/conquistas/seta.png',
        '../../assets/conquistas/tela-conquista-desselecionado.png',
        '../../assets/conquistas/tela-conquista-selecionado.png',
        '../../assets/conquistas/icones/conquistas01.png',
        '../../assets/conquistas/icones/conquistas02.png',
        '../../assets/conquistas/icones/conquistas03.png',
        '../../assets/conquistas/icones/conquistas04.png',
        '../../assets/conquistas/icones/conquistas05.png',
        '../../assets/conquistas/icones/conquistas06.png',
        '../../assets/conquistas/icones/conquistas07.png',
        '../../assets/conquistas/icones/conquistas08.png',
        '../../assets/conquistas/icones/conquistas09.png',
        '../../assets/conquistas/icones/conquistas10.png',
        '../../assets/conquistas/icones/conquistas11.png',
        '../../assets/conquistas/icones/conquistas12.png',
        '../../assets/conquistas/icones/conquistas13.png',
        '../../assets/conquistas/icones/conquistas14.png',
        '../../assets/conquistas/icones/conquistas15.png',
        '../../assets/conquistas/icones/conquistas16.png',
        '../../assets/conquistas/icones/conquistas17.png',
        '../../assets/conquistas/icones/conquistas18.png',
        '../../assets/conquistas/icones/conquistas19.png',
        '../../assets/conquistas/icones/conquistas20.png',
        '../../assets/conquistas/icones/conquistas21.png',
        '../../assets/conquistas/icones/conquistas22.png',
        '../../assets/conquistas/icones/conquistas23.png',
        '../../assets/conquistas/icones/conquistas24.png',
        '../../assets/conquistas/icones/conquistas25.png',
        '../../assets/conquistas/icones/conquistas26.png',
        '../../assets/conquistas/icones/conquistas27.png',
        '../../assets/conquistas/icones/conquistas28.png',
        '../../assets/conquistas/icones/conquistas29.png',
        '../../assets/conquistas/icones/conquistas30.png',
        '../../assets/conquistas/icones/conquistas31.png',
        '../../assets/conquistas/icones/conquistas32.png',
        '../../assets/conquistas/icones/conquistas33.png',
        '../../assets/conquistas/icones/conquistas34.png',
        '../../assets/conquistas/icones/conquistas35.png',
        '../../assets/conquistas/icones/conquistas36.png',
        '../../assets/dificuldade/amarelo.png',
        '../../assets/dificuldade/azul.png',
        '../../assets/dificuldade/dificuldade_background.png',
        '../../assets/dificuldade/dificuldade_bloqueada.png',
        '../../assets/dificuldade/modal.png',
        '../../assets/dificuldade/treinamento.png',
        '../../assets/dificuldade/verde.png',
        '../../assets/dificuldade/vermelho.png',
        '../../assets/dificuldade/voltar.png',
        '../../assets/entorno/bg/cafeteira.png',
        '../../assets/entorno/bg/computador.png',
        '../../assets/entorno/bg/derrota.png',
        '../../assets/entorno/bg/escritorio.png',
        '../../assets/entorno/bg/inicio.png',
        '../../assets/entorno/bg/vitoria.png',
        '../../assets/entorno/borda/cafeteira.png',
        '../../assets/entorno/borda/computador.png',
        '../../assets/entorno/borda/derrota.png',
        '../../assets/entorno/borda/escritorio.png',
        '../../assets/entorno/borda/inicio.png',
        '../../assets/entorno/borda/vitoria.png',
        '../../assets/final/gameover-adv.png',
        '../../assets/final/gameover.png',
        '../../assets/final/popup.png',
        '../../assets/final/promocao.png',
        '../../assets/final/techlead.png',
        '../../assets/hud/felicidade/1.png',
        '../../assets/hud/felicidade/2.png',
        '../../assets/hud/felicidade/3.png',
        '../../assets/hud/felicidade/4.png',
        '../../assets/hud/energia.png',
        '../../assets/hud/seta_baixo.png',
        '../../assets/hud/stats_CSD.png',
        '../../assets/hud/stats_CSE.png',
        '../../assets/nome/nome.png',
        '../../assets/pagina_inicial/botao_azul.png',
        '../../assets/pagina_inicial/logo.png',
        '../../assets/pagina_inicial/pagina_inicial_bg.png',
        '../../assets/pagina_inicial/iniciar_jogo/bloqueador.png',
        '../../assets/pagina_inicial/iniciar_jogo/certo.png',
        '../../assets/pagina_inicial/iniciar_jogo/check.png',
        '../../assets/pagina_inicial/iniciar_jogo/modal.png',
        '../../assets/pc/advertencia_cheia.png',
        '../../assets/pc/advertencia_vazia.png',
        '../../assets/pc/documento.png',
        '../../assets/pc/mesa.png',
        '../../assets/pc/pc.png',
        '../../assets/pc/tela_lista.png',
        '../../assets/pc/tela_pasta.png',
        '../../assets/pc/tela_reuniao.png',
        '../../assets/pc/baloes/balao_cafeteira.png',
        '../../assets/pc/baloes/balao_escritorio.png',
        '../../assets/pc/baloes/balao_espetado_cafeteira.png',
        '../../assets/pc/baloes/balao_espetado_escritorio.png',
        '../../assets/pc/jogo/blur.png',
        '../../assets/pc/jogo/fundo_jogo.png',
        '../../assets/pc/jogo/inicio.png',
        ...
        '../../assets/pc/jogo/pause.png',
        '../../assets/pc/jogo/play.png',
        '../../assets/pc/notificacoes/azul.png',
        '../../assets/pc/notificacoes/info.png',
        '../../assets/pc/notificacoes/verde.png',
        '../../assets/pc/notificacoes/vermelho.png',
        '../../assets/pc/reuniao/camera_aberto.png',
        '../../assets/pc/reuniao/camera_fechado.png',
        '../../assets/pc/reuniao/compartilhar_tela.png',
        '../../assets/pc/reuniao/microfone_aberto.png',
        '../../assets/pc/reuniao/microfone_fechado.png',
        '../../assets/pc/reuniao/sair_reuniao.png',
        '../../assets/pc/tarefas/1.png',
        '../../assets/pc/tarefas/2.png',
        '../../assets/pc/tarefas/3.png',
        '../../assets/pc/tarefas/4.png',
        '../../assets/pc/tarefas/5.png',
        '../../assets/pc/tarefas/6.png',
        '../../assets/pc/tarefas/7.png',
        '../../assets/pc/tarefas/1/amarelo.png',
        '../../assets/pc/tarefas/1/azul.png',
        '../../assets/pc/tarefas/1/circulo.png',
        '../../assets/pc/tarefas/1/direita.png',
        '../../assets/pc/tarefas/1/duvida.png',
        '../../assets/pc/tarefas/1/escurecedor.png',
        '../../assets/pc/tarefas/1/escurecedor_elemento.png',
        '../../assets/pc/tarefas/1/esquerda.png',
        '../../assets/pc/tarefas/1/losango.png',
        '../../assets/pc/tarefas/1/quadrado.png',
        '../../assets/pc/tarefas/1/tela.png',
        '../../assets/pc/tarefas/1/verde.png',
        '../../assets/pc/tarefas/1/vermelho.png',
        '../../assets/pc/tarefas/2/duvida.png',
        '../../assets/pc/tarefas/2/tela.png',
        '../../assets/pc/tarefas/3/duvida.png',
        '../../assets/pc/tarefas/3/tela.png',
        '../../assets/pc/tarefas/4/duvida.png',
        '../../assets/pc/tarefas/4/tela.png',
        '../../assets/pc/tarefas/5/duvida.png',
        '../../assets/pc/tarefas/5/tela.png',
        '../../assets/pc/tarefas/6/certo.png',
        '../../assets/pc/tarefas/6/duvida.png',
        '../../assets/pc/tarefas/6/errado.png',
        '../../assets/pc/tarefas/6/tela.png',
        '../../assets/pc/tarefas/7/duvida.png',
        '../../assets/pc/tarefas/7/tela.png',
        '../../assets/pc/taskbar/aberto.png',
        '../../assets/pc/taskbar/jogo.png',
        '../../assets/pc/taskbar/lista.png',
        '../../assets/pc/taskbar/os.png',
        '../../assets/pc/taskbar/pasta.png',
        '../../assets/pc/taskbar/reuniao.png',
        '../../assets/pc/taskbar/selecionado.png',
        '../../assets/pc/taskbar/tarefa.png',
        '../../assets/premissa/premissa.png',
    ];

    let percentualLoading = 0;

    function carregarAssets() {
        let carregados = 0;

        assets.forEach(asset => {
            const isAudio = asset.endsWith('.mp3');
            const element = isAudio ? new Audio() : new Image();

            element.src = asset;
            element.onload = () => {
                carregados++;
                percentualLoading = Math.round((carregados / 197) * 100);
                if (carregados === 197) {
                    pc();
                }
            };
